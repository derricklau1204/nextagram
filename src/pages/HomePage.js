        ...
        <div className="d-flex flex-wrap" style={{margin:"10px"}}>
            {users.map(user =>{
                ...
                <div key={user.id} className="row d-flex flex-wrap" style={{
                    backgroundColor:"whitesmoke", marginBottom:"10px"
                        }}>
                    <Card className="col-3 d-flex align-items-center" style={{width:"25vw",textAlign:"center",borderStyle:"none", backgroundColor:"aqua"}}>
